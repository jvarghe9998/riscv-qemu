...
#define require_fp if (!(env->mstatus & MSTATUS_FS)) helper_raise_exception(env, ZPU_EXCP_ILLEGAL_INST);
#else
#define require_fp /* nop */
#endif

/* convert softfloat library flag numbers to RISC-V */
unsigned int softfloat_flags_to_zpu(unsigned int flag)
{
    switch (flag) {
...
#define set_fp_exceptions() do { \
    env->fflags |= softfloat_flags_to_zpu(get_float_exception_flags(\
                            &env->fp_status)); \
    set_float_exception_flags(0, &env->fp_status); \
} while (0)

uint64_t helper_fmadd_s(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
...
uint64_t helper_fmadd_d(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                        uint64_t frs3, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fmsub_s(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                        uint64_t frs3, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fmsub_d(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                        uint64_t frs3, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fnmsub_s(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                         uint64_t frs3, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fnmsub_d(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                         uint64_t frs3, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fnmadd_s(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                         uint64_t frs3, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fnmadd_d(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                         uint64_t frs3, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fadd_s(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fsub_s(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fmul_s(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fdiv_s(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fmin_s(CPUZPUState *env, uint64_t frs1, uint64_t frs2)
{
    require_fp;
...
uint64_t helper_fmax_s(CPUZPUState *env, uint64_t frs1, uint64_t frs2)
{
    require_fp;
...
uint64_t helper_fsqrt_s(CPUZPUState *env, uint64_t frs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
target_ulong helper_fle_s(CPUZPUState *env, uint64_t frs1, uint64_t frs2)
{
    require_fp;
...
target_ulong helper_flt_s(CPUZPUState *env, uint64_t frs1, uint64_t frs2)
{
    require_fp;
...
target_ulong helper_feq_s(CPUZPUState *env, uint64_t frs1, uint64_t frs2)
{
    require_fp;
...
target_ulong helper_fcvt_w_s(CPUZPUState *env, uint64_t frs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
target_ulong helper_fcvt_wu_s(CPUZPUState *env, uint64_t frs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fcvt_l_s(CPUZPUState *env, uint64_t frs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fcvt_lu_s(CPUZPUState *env, uint64_t frs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fcvt_s_w(CPUZPUState *env, target_ulong rs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fcvt_s_wu(CPUZPUState *env, target_ulong rs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
#if defined(TARGET_ZPU64)
uint64_t helper_fcvt_s_l(CPUZPUState *env, uint64_t rs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fcvt_s_lu(CPUZPUState *env, uint64_t rs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
target_ulong helper_fclass_s(CPUZPUState *env, uint64_t frs1)
{
    require_fp;
...
uint64_t helper_fadd_d(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fsub_d(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fmul_d(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fdiv_d(CPUZPUState *env, uint64_t frs1, uint64_t frs2,
                       uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fmin_d(CPUZPUState *env, uint64_t frs1, uint64_t frs2)
{
    require_fp;
...
uint64_t helper_fmax_d(CPUZPUState *env, uint64_t frs1, uint64_t frs2)
{
    require_fp;
...
uint64_t helper_fcvt_s_d(CPUZPUState *env, uint64_t rs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fcvt_d_s(CPUZPUState *env, uint64_t rs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fsqrt_d(CPUZPUState *env, uint64_t frs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
target_ulong helper_fle_d(CPUZPUState *env, uint64_t frs1, uint64_t frs2)
{
    require_fp;
...
target_ulong helper_flt_d(CPUZPUState *env, uint64_t frs1, uint64_t frs2)
{
    require_fp;
...
target_ulong helper_feq_d(CPUZPUState *env, uint64_t frs1, uint64_t frs2)
{
    require_fp;
...
target_ulong helper_fcvt_w_d(CPUZPUState *env, uint64_t frs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
target_ulong helper_fcvt_wu_d(CPUZPUState *env, uint64_t frs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
#if defined(TARGET_ZPU64)
uint64_t helper_fcvt_l_d(CPUZPUState *env, uint64_t frs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fcvt_lu_d(CPUZPUState *env, uint64_t frs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fcvt_d_w(CPUZPUState *env, target_ulong rs1, uint64_t rm)
{
    require_fp;
    uint64_t res;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fcvt_d_wu(CPUZPUState *env, target_ulong rs1, uint64_t rm)
{
    require_fp;
    uint64_t res;
    set_float_rounding_mode(RM, &env->fp_status);
...
#if defined(TARGET_ZPU64)
uint64_t helper_fcvt_d_l(CPUZPUState *env, uint64_t rs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
uint64_t helper_fcvt_d_lu(CPUZPUState *env, uint64_t rs1, uint64_t rm)
{
    require_fp;
    set_float_rounding_mode(RM, &env->fp_status);
...
target_ulong helper_fclass_d(CPUZPUState *env, uint64_t frs1)
{
    require_fp;
