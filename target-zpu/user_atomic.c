...
/* The code in this file runs outside of cpu_loop and may not raise
   any exceptions. Instead, it should return one of ZPU_AMO_* consts.
...
static int rv_do_sc(ENV, int rd, int rs1, int rs2, int width)
{
    ...
    switch(width) {
        ...
        default: return ZPU_AMO_BADINSN; /* should not happen */
    }
...
int zpu_cpu_do_usermode_amo(CPUState* cs)
{
